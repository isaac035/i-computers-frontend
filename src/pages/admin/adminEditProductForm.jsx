...
export default function EditProductForm(){
    ...
    const [isAvailabel, setIsAvailabel] = useState(location?.state?.isAvailabel||false)
    ...
    return(
        <div className="w-full max-h-full flex flex-wrap p-4 overflow-y-scroll items-start gap-0 ">
            ...
            <div className="w-full h-[100px] bg-white shadow rounded-b-md flex items-center p-4 justify-between mb-8">
                ...
                <h1 className="text-2xl font-semibold text-secondary ml-2">Edit Product</h1>

                <div className="flex gap-2">

                    <Link to ="/admin/products" className="p-2 bg-red-600 text-white rounded-md hover:bg-red-700"> Cancel </Link>
                    <button className="p-2 bg-green-600 text-white rounded-md cursor-pointer hover:bg-green-800" onClick={handleUpdate}> Update</button>
            ...
            <input disabled="text" value={productId} onChange={(e)=>setProductId(e.target.value)} className="w-full h-[40px] rounded-md border-2 border-gray-300 p-2 mb-4"/>
