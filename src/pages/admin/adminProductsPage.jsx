  ...
  return (
    <div className="w-full max-h-full flex flex-col p-4 overflow-y-scroll items-start gap-0 ">
      <div className="w-full h-[100px] bg-white shadow rounded-b-md flex items-center p-4 justify-between mb-8">
        ...
        <h1 className="text-2xl font-semibold text-secondary ml-2">
          Add Product
        </h1>
        ...
        <div className="flex gap-4 justify-center items-center">
          ...
          <button
            ...
            className="bg-accent text-white px-4 py-2 rounded-md hover:scale-[1.1] transition duration-200"
          >
            Refresh
          </button>
        </div>
              ...
              <tr key={items.productId} className="border-b odd:bg-gray-200">
                ...
                <td>
                  <div className="flex gap-2 justify-center">
                    ...
                    <DeleteProductModal product={items} refresh={()=>{setIsLoading(true)}}/>
                  </div>
                </td>
              </tr>
            );
      ...
      <Link
        ...
        className="w-[80px] h-[80px] bg-accent text-white rounded-full text-2xl flex items-center justify-center fixed right-[35px] bottom-[35px] hover:scale-[1.3] transition duration-200"
      >
        <FaPlus />
      </Link>
    </div>
